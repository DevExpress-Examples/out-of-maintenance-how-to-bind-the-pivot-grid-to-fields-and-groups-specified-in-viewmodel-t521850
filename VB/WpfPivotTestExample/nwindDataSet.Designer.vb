...
Namespace PivotGridViewModelBinding
    ...
    Partial Public Class nwindDataSet
        ...
        Partial Public Class SalesPersonDataTable
            ...
            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
            Public Function AddSalesPersonRow(ByVal Country As String, ByVal ProductName As String, ByVal CategoryName As String, ByVal OrderDate As Date, ByVal Quantity As Short, ByVal Sales_Person As String, ByVal Extended_Price As Decimal, ByVal Discount As Single, ByVal UnitPrice As Decimal) As SalesPersonRow
                Dim rowSalesPersonRow As SalesPersonRow = (CType(Me.NewRow(), SalesPersonRow))
                Dim columnValuesArray() As Object = { Country, ProductName, CategoryName, OrderDate, Quantity, Sales_Person, Extended_Price, Nothing, Discount, UnitPrice}
    ...
    End Class
End Namespace
Namespace PivotGridViewModelBinding.nwindDataSetTableAdapters
    ...
    Partial Public Class SalesPersonTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        Country, ProductName, CategoryName, OrderDate, Quantity, [Sales Per" & "son], [Extended Price], OrderID, Discount, UnitPrice" & ControlChars.CrLf & "FROM            SalesPerso" & "n"
